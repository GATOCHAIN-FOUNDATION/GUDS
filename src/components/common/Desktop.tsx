      ...
      <div className="flex justify-center items-center w-full h-full overflow-hidden">
        <div className="flex items-center justify-center w-[99%] py-3 h-screen mx-auto border    overflow-hidden">
          ...
          >
            ...
            />
            <div
              className="absolute flex p-2 justify-center items-center top-0 left-0 w-[400px] rounded-2xl h-full bg-opacity-50  "
              style={{
                background: `rgba(255, 255, 255, 0.06)`,
                backdropFilter: `blur(45px)`,
              }}
            >
              <div className="h-full overflow-x-hidden overflow-y-auto flex justify-center items-center rounded-[20px]">
                {children}
              </div>
            </div>
            {/* )} */}
